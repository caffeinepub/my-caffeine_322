...
const articles: Article[] = [
  ...
  {
    title: "ইসরায়েলের মরুভূমিতে সবুজ বিপ্লব — ড্রিপ ও সোলার",
    summary:
      "ইসরায়েলের ভোলকানি সেন্টার মরুভূমিতে সোলার প্যানেল ও ড্রিপ সেচ সমন্বয়ে কৃষি বিপ্লব ঘটিয়েছে। আগে যেসব জায়গায় চাষ অকল্পনীয় ছিল, এখন সেখানে টমেটো, শসা ও গোলমরিচ উৎপাদন হচ্ছে। এই প্রযুক্তি বাংলাদেশের খরা-প্রবণ চরাঞ্চলে প্রয়োগযোগ্য।",
    category: "আন্তর্জাতিক",
    country: "🇮🇱 ইসরায়েল",
    tags: ["#মরুভূমি", "#সোলার", "#ড্রিপ", "#VolcaniCenter"],
