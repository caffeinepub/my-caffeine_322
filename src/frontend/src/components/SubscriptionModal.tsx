...
const paymentMethods: {
...
}[] = [
  {
    ...
    instructions: [
      ...
      "পেমেন্ট সম্পন্ন হলে নিচে জানান",
    ],
  },
  {
    id: "nagad",
  ...
  },
  {
    ...
    icon: "🏦",
    instructions: [
      "ব্যাংক ট্রান্সফার বা কার্ড পেমেন্টের জন্য যোগাযোগ করুন",
      `বিকাশ: ${BKASH_NUMBER}`,
    ],
  },
];
          ...
          <div className="mb-4 bg-gray-50 rounded-xl p-3">
            ...
            <ol className="space-y-1">
              {selected.instructions.map((step, i) => (
                <li key={step} className="text-xs text-foreground flex gap-2">
